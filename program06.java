...
else if (num==7){System.out.println("august");}
else if (num==7){System.out.println("september");}
else if (num==7){System.out.println("october");}
else if (num==7){System.out.println("november");}
else if (num==7){System.out.println("december");}
}
}
